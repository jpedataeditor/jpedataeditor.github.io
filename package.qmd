...
7. After the folder upload has finished, reload the dataverse page of your deposit. Check your files are visible at the bottom. Click on *Submit for Review*. ![](img/dv5.png)
8. After verification of your deposit by the Data Editor, your package will be published on the JPE dataverse, and the process of reproducibility checks comes to an end.
